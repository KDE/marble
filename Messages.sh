...
$XGETTEXT_QT src/QtMainWindow.cpp src/qtmain.cpp src/ControlView.cpp `find src/plugins -name '*.cpp' | grep -v '/test/'` `find src/lib -name '*.cpp'` src/lib/global.h -o $podir/marble_qt.pot
