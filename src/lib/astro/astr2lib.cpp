...
void Plan200::term(int i1, int i, int it, double dlc, double dls, double drc, double drs, double dbc, double dbs)
{
    if (it == 0)
...
Vec3 Plan200::Mercury(double t) // position of Mercury at time t
{
    ...
    */
    ...
    dl = 714.0 + 292.66 * cos(m1) + 71.96 * cos(2 * m1) + 18.16 * cos(3 * m1) + 4.61 * cos(4 * m1) + 3.81 * sin(2 * m1) + 2.43 * sin(3 * m1)
        + 1.08 * sin(4 * m1);
    dr = 55.94 * sin(m1) + 11.36 * sin(2 * m1) + 2.6 * sin(3 * m1);
    db = 73.4 * cos(m1) + 29.82 * cos(2 * m1) + 10.22 * cos(3 * m1) + 3.28 * cos(4 * m1) - 40.44 * sin(m1) - 16.55 * sin(2 * m1) - 5.56 * sin(3 * m1)
        - 1.72 * sin(4 * m1);
...
Vec3 Plan200::Mars(double t) // position of Mars at time t
{
    ...
    dl = dl + 52.49 * sin(p2 * (0.1868 + 0.0549 * t)) + 0.61 * sin(p2 * (0.922 + 0.3307 * t)) + 0.32 * sin(p2 * (0.4731 + 2.1485 * t))
        + 0.28 * sin(p2 * (0.9467 + 1.1133 * t));
...
Vec3 PosJIo(double t)
{
    ...
    nu = -5596.0 * sin(p3 - p4) - 2198.0 * sin(p1 + p2 - 2.0 * (pij + gg)) + 1321.0 * sin(phl) - 1157.0 * sin(l1 - 2.0 * l2 + p4)
        - 1940.0 * sin(l1 - 2.0 * l2 + p3) + 791.0 * sin(l1 - 2.0 * l2 + p2) + 82363.0 * sin(2.0 * (l1 - l2));
    nu *= 1E-7;
    ...
    rs.assign(ax * (1 + xi) * cos(l1 - psi + nu), ax * (1 + xi) * sin(l1 - psi + nu), ax * ze);
...
Vec3 PosEuropa(double t)
{
    ...
    xi = -3187 * cos(l2 - p3) - 1738 * cos(l2 - p4) + 93748 * cos(l1 - l2);
    xi *= 1E-7;
    nu = -1158 * sin(2 * (psi - pij)) + 1715 * sin(-2 * (pij + gg) + th3 + psi) - 1846 * sin(gg) + 2397 * sin(p3 - p4) - 3172 * sin(phl) - 1993 * sin(l2 - l3)
        + 1844 * sin(l2 - p2) + 6394 * sin(l2 - p3) + 3451 * sin(l2 - p4) + 4159 * sin(l1 - 2 * l2 + p4) + 7571 * sin(l1 - 2 * l2 + p3)
        - 1491 * sin(l1 - 2 * l2 + p3) - 185640 * sin(l1 - l2) - 803 * sin(l1 - l3) + 915 * sin(2 * (l1 - l2));
    nu *= 1E-7;
    ze = 81575 * sin(l2 - th2 + nu) + 4512 * sin(l2 - th3 + nu) - 3286 * sin(l2 - psi + nu);
    ze *= 1E-7;

    // convert to rectangular coordinates in Jovian equatorial

    rs.assign(ax * (1 + xi) * cos(l2 - psi + nu), ax * (1 + xi) * sin(l2 - psi + nu), ax * ze);
...
Vec3 PosGanymede(double t)
{
    ...
    xi = -14691 * cos(l3 - p3) - 1758 * cos(2 * (l3 - l4)) + 6333 * cos(l2 - l3);
    xi *= 1E-7;
    nu = -1488 * sin(2 * (pij + psi)) + 411 * sin(-th3 + psi) + 346 * sin(-th4 + psi) - 2338 * sin(gg) + 6558 * sin(p3 - p4)
        + 523 * sin(p1 + p3 - 2 * (pij + gg)) + 341 * sin(phl) - 943 * sin(l3 - l4) + 29387 * sin(l3 - p3) + 15800 * sin(l3 - p4) + 3218 * sin(2 * (l3 - l4))
        + 226 * sin(3 * l3 - 2 * l4) - 12038 * sin(l2 - l3) - 662 * sin(l1 - 2 * l2 + p4) - 1246 * sin(l1 - 2 * l2 + p3) + 699 * sin(l1 - 2 * l2 + p2)
        + 217 * sin(l1 - l3);
    nu *= 1E-7;
    ze = -2793 * sin(l3 - th2 + nu) + 32387 * sin(l3 - th3 + nu) + 6871 * sin(l3 - th4 + nu) - 16876 * sin(l3 - psi + nu);
    ze *= 1E-7;

    // convert to rectangular coordinates in Jovian equatorial

    rs.assign(ax * (1 + xi) * cos(l3 - psi + nu), ax * (1 + xi) * sin(l3 - psi + nu), ax * ze);
...
Vec3 PosCallisto(double t)
{
    ...
    xi = 1656 * cos(l4 - p3) - 73328 * cos(l4 - p4) + 182 * cos(l4 - pij) - 541 * cos(l4 + p4 - 2 * (pij + gg)) - 269 * cos(2 * (l4 - p4)) + 974 * cos(l3 - l4);
    xi *= 1E-7;
    nu = -407 * sin(2 * (psi - p4)) + 309 * sin(-2 * p4 + th4 + psi) - 4840 * sin(2 * (psi - pij)) + 2074 * sin(-th4 + psi) - 5605 * sin(gg) - 204 * sin(2 * gg)
        - 495 * sin(5 * gp - 2 * gg + ph2) + 234 * sin(p4 - pij) - 6112 * sin(p3 - p4) - 3318 * sin(l4 - p3) + 145573 * sin(l4 - p4) + 178 * sin(l4 - pij - gg)
        - 363 * sin(l4 - pij) + 1085 * sin(l4 + p4 - 2 * (pij + gg)) + 672 * sin(2 * (l4 - p4)) + 218 * sin(2 * (l4 - pij - gg)) + 167 * sin(2 * l4 - th4 - psi)
        - 142 * sin(2 * (l4 - psi)) + 148 * sin(l3 - 2 * l4 + p4) - 390 * sin(l3 - l4) - 195 * sin(2 * (l3 - l4)) + 185 * sin(3 * l3 - 7 * l4 + 4 * p4);
    nu *= 1E-7;
    ze = 773 * sin(l4 - 2 * (pij + gg) + psi + nu) - 5075 * sin(l4 - th3 + nu) + 44300 * sin(l4 - th4 + nu) - 76493 * sin(l4 - psi + nu);
    ze *= 1E-7;

    rs.assign(ax * (1 + xi) * cos(l4 - psi + nu), ax * (1 + xi) * sin(l4 - psi + nu), ax * ze);
...
Vec3 PosSEnceladus(double t)
{
    ...
    th1 = 145.0 - 152.7 * dt;
    l1 = 200.155 + n * d + 0.256333 * sin((59.4 + 32.73 * dt) * M_PI / 180.0) + 0.217333 * sin((119.2 + 93.18 * dt) * M_PI / 180.0);
    p = 312.7 + 123.42 * dt;
...
Vec3 PosSDione(double t)
{
    ...
    l1 = 255.1183 + n * d - 0.0146667 * sin((59.4 + 32.73 * dt) * M_PI / 180.0) - 0.0125 * sin((119.2 + 93.18 * dt) * M_PI / 180.0);
    p = 173.6 + 30.8381 * dt;
...
void SatRhea(double t, Vec3 &rs, Vec3 &vs)
{
    ...
    ii = ie - 7.9412480966E-4 + kap * sg0 * cos(pp) + 3.5081117965E-4 * cos(nt);
    omg = oe - 1.3613568166E-4 + (kap * sg0 * ot + 3.5081117965E-4 * sin(nt)) / sin(ie);
...
void SatTitan(double t, Vec3 &rs, Vec3 &vs)
{
    ...
    gg = 2 * lms + psi;
    lam =
        pi2 * frac((261.3121 + 22.57697385 * d) / 360.0) + kap * (sg0 * tan(0.5 * ie) * s4 - 0.000176 * sin(ls) - 0.000215 * sin(2 * lms) + 0.000057 * sin(gg));
...
void NepTriton(double t, Vec3 &rs, Vec3 &vs)
{
    ...
    rs.assign(1.0, pi2 * frac((298.72 + 2.58 * sin(nn) - 0.04 * sin(2 * nn)) / 360.0), pi2 * frac((42.63 - 1.9 * cos(nn) + 0.01 * cos(2 * nn)) / 360.0));
    rs = polcar(rs);
