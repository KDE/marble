...
void OsmPresetLibrary::initializeOsmVisualCategories()
{
    ...
    s_visualCategories[ OsmTag( "shop", "alcohol" ) ]               = GeoDataFeature::ShoppingBeverages;
    s_visualCategories[ OsmTag( "shop", "hifi" ) ]                  = GeoDataFeature::ShoppingHifi;
    s_visualCategories[ OsmTag( "shop", "supermarket" ) ]           = GeoDataFeature::ShoppingSupermarket;
