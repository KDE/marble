...
#include "DGMLFolderTagHandler.h"
...
DGML_DEFINE_TAG_HANDLER(Folder)

DGMLFolderTagHandler::DGMLFolderTagHandler()
    : GeoDataTagHandler()
{
}
...
void DGMLFolderTagHandler::parse(GeoDataParser& parser) const
{
