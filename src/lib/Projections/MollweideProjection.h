...
#ifndef MOLLWEIDEPROJECTION_H
#define MOLLWEIDEPROJECTION_H
...
/**
 * @short A class to implement the Mollweide projection.
 */

class MollweideProjection : public AbstractProjection
{
    // Not a QObject so far because we don't need to send signals.
 public:

    /**
     * @brief Construct a new MollweideProjection.
     */
    explicit MollweideProjection();

    virtual ~MollweideProjection();
