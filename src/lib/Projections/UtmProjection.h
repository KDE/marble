...
#ifndef UTMPROJECTION_H
#define UTMPROJECTION_H
...
/**
 * @short A class to implement the Universal Transverse Mercator projection.
 */

class UtmProjection : public AbstractProjection
{
