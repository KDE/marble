...
{
    Q_ASSERT(isStartElement() && name() == QLatin1String("StationList"));
...
{
    Q_ASSERT(isStartElement() && name() == QLatin1String("Station"));
...
{
    Q_ASSERT(isStartElement() && name() == QLatin1String("Point"));
