...
NotesItem::NotesItem(QObject *parent)
    ...
    , m_pixmap_open(QPixmap(MarbleDirs::dataFilePath(QStringLiteral("bitmaps/notes_open.png"))))
    , m_pixmap_closed(QPixmap(MarbleDirs::dataFilePath(QStringLiteral("bitmaps/notes_closed.png"))))
{
